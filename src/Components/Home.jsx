...
const Home = () => {
  return (
    <div className='max-w-[80%] mx-auto pt-40 sm:pt-45 h-fit md:min-h-[100vh]'>
      ...
      <div className=''>
        <h1 className='text-white  font-bold text-2xl sm:text-4xl lg:text-5xl'>Hello! I Am Ibad Ahmed</h1>
...
<div className='mt-13 sm:mt-16 flex gap-5'>
    ...
    <button className='bg-black text-white min-w-30 py-2 px-2 font-medium rounded-br-2xl rounded-t-2xl hover:text-black  text-black hover:text-white'><a href="/public/Ibad_CV.pdf" 
